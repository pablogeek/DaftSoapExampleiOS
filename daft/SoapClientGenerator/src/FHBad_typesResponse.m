...
@implementation FHBad_typesResponse
...
- (id) initWithXml: (DDXMLElement*) __node __request:(FHBRequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"ad_types"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(FHBad_type*)[__request createObject:child type:[FHBad_type class]]];
        }
...
{
    for (FHBad_type* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[FHBad_type class] name:@"ad_types" URI:@"http://api.daft.ie/v2/" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (void)removeObjectIdenticalTo:(FHBad_type*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(FHBad_type*)anObject {
...
+ (id)array {
	return [[ FHBad_typesResponse alloc] init];
}

+ (id)arrayWithObject:(FHBad_type*)anObject {
	return [[ FHBad_typesResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const FHBad_type* *)objects count:(NSUInteger)cnt {
	return [[ FHBad_typesResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(FHBad_type*)firstObj, ... {
	FHBad_typesResponse* a = [ FHBad_typesResponse array];
	id eachObject;
...
- (id)initWithObjects:(FHBad_type*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ FHBad_typesResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ FHBad_typesResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ FHBad_typesResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ FHBad_typesResponse alloc] initWithCapacity:numItems];
}
