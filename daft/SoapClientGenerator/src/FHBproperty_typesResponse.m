...
@implementation FHBproperty_typesResponse

@synthesize items;

+ (FHBproperty_typesResponse *)createWithXml:(DDXMLElement *)__node __request:(FHBRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(FHBRequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"property_types"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(FHBproperty_type*)[__request createObject:child type:[FHBproperty_type class]]];
        }
...
{
    for (FHBproperty_type* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[FHBproperty_type class] name:@"property_types" URI:@"http://api.daft.ie/v2/" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (FHBproperty_type*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(FHBproperty_type*)anObject {
...
- (BOOL)containsObject:(FHBproperty_type*)anObject {
...
- (NSUInteger)indexOfObject:(FHBproperty_type*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(FHBproperty_type*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(FHBproperty_type*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(FHBproperty_type*)anObject inRange:(NSRange)range {
...
- (void)addObject:(FHBproperty_type*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(FHBproperty_type*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(FHBproperty_type*)anObject {
...
- (void)removeObject:(FHBproperty_type*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(FHBproperty_type*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(FHBproperty_type*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(FHBproperty_type*)anObject {
...
+ (id)array {
	return [[ FHBproperty_typesResponse alloc] init];
}

+ (id)arrayWithObject:(FHBproperty_type*)anObject {
	return [[ FHBproperty_typesResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const FHBproperty_type* *)objects count:(NSUInteger)cnt {
	return [[ FHBproperty_typesResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(FHBproperty_type*)firstObj, ... {
	FHBproperty_typesResponse* a = [ FHBproperty_typesResponse array];
	id eachObject;
...
- (id)initWithObjects:(FHBproperty_type*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ FHBproperty_typesResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ FHBproperty_typesResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ FHBproperty_typesResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ FHBproperty_typesResponse alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const FHBproperty_type* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(FHBproperty_type*, FHBproperty_type*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(FHBproperty_type*, FHBproperty_type*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(FHBproperty_type*, FHBproperty_type*, void *))compare context:(void *)context {
