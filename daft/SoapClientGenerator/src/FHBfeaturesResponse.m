...
@implementation FHBfeaturesResponse

@synthesize items;

+ (FHBfeaturesResponse *)createWithXml:(DDXMLElement *)__node __request:(FHBRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(FHBRequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"features"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(FHBfeature*)[__request createObject:child type:[FHBfeature class]]];
        }
...
{
    for (FHBfeature* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[FHBfeature class] name:@"features" URI:@"http://api.daft.ie/v2/" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (FHBfeature*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(FHBfeature*)anObject {
...
- (BOOL)containsObject:(FHBfeature*)anObject {
...
- (NSUInteger)indexOfObject:(FHBfeature*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(FHBfeature*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(FHBfeature*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(FHBfeature*)anObject inRange:(NSRange)range {
...
- (void)addObject:(FHBfeature*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(FHBfeature*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(FHBfeature*)anObject {
...
- (void)removeObject:(FHBfeature*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(FHBfeature*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(FHBfeature*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(FHBfeature*)anObject {
...
+ (id)array {
	return [[ FHBfeaturesResponse alloc] init];
}

+ (id)arrayWithObject:(FHBfeature*)anObject {
	return [[ FHBfeaturesResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const FHBfeature* *)objects count:(NSUInteger)cnt {
	return [[ FHBfeaturesResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(FHBfeature*)firstObj, ... {
	FHBfeaturesResponse* a = [ FHBfeaturesResponse array];
	id eachObject;
...
- (id)initWithObjects:(FHBfeature*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ FHBfeaturesResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ FHBfeaturesResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ FHBfeaturesResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ FHBfeaturesResponse alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const FHBfeature* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(FHBfeature*, FHBfeature*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(FHBfeature*, FHBfeature*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(FHBfeature*, FHBfeature*, void *))compare context:(void *)context {
