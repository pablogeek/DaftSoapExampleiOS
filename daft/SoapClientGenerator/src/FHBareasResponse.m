...
@implementation FHBareasResponse

@synthesize items;

+ (FHBareasResponse *)createWithXml:(DDXMLElement *)__node __request:(FHBRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(FHBRequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"areas"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(FHBarea*)[__request createObject:child type:[FHBarea class]]];
        }
...
{
    for (FHBarea* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[FHBarea class] name:@"areas" URI:@"http://api.daft.ie/v2/" parent:__parent skipNullProperty:__request.SkipNullProperties];
...
- (FHBarea*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(FHBarea*)anObject {
...
- (BOOL)containsObject:(FHBarea*)anObject {
...
- (NSUInteger)indexOfObject:(FHBarea*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(FHBarea*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(FHBarea*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(FHBarea*)anObject inRange:(NSRange)range {
...
- (void)addObject:(FHBarea*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(FHBarea*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(FHBarea*)anObject {
...
- (void)removeObject:(FHBarea*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(FHBarea*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(FHBarea*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(FHBarea*)anObject {
...
+ (id)array {
	return [[ FHBareasResponse alloc] init];
}

+ (id)arrayWithObject:(FHBarea*)anObject {
	return [[ FHBareasResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const FHBarea* *)objects count:(NSUInteger)cnt {
	return [[ FHBareasResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(FHBarea*)firstObj, ... {
	FHBareasResponse* a = [ FHBareasResponse array];
	id eachObject;
...
- (id)initWithObjects:(FHBarea*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ FHBareasResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ FHBareasResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ FHBareasResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ FHBareasResponse alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const FHBarea* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(FHBarea*, FHBarea*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(FHBarea*, FHBarea*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(FHBarea*, FHBarea*, void *))compare context:(void *)context {
