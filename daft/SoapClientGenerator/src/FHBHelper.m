...
{
    DDXMLNode* child=[FHBHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[FHBHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[FHBHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
